...
## [0.1.0](https://github.com/Gefferson-Souza/Tyrus/releases/tag/tyrus_codegen-v0.1.0) - 2026-02-14

### Added

- Add support for TypeScript `Record` types and update project documentation. ([#2](https://github.com/Gefferson-Souza/Tyrus/pull/2))
...
- streamline type annotation extraction and optimize identifier string conversion.
- Reorder Axum router layers and update generated `AppError` type references in tests.
